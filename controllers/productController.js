...
product.productCtaegory = productCategory;
product.productDescription = productDescription;
product.productImage = uploadImage.secure_url;

    await product.save();
    res.status(200).json({msg: "Product created successfully with iamge"});
   }else{
...
product.productDescription = productDescription;
    ...
    await product.save();
    res.status(200).json({msg: "Product created successfully w/o image"});
